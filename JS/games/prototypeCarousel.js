const prototypes = [
  {
    id: 1,
    img: `${BASE}ASSETS/IMAGES/games/prototypes/colourSwitch.webp`,
  ...
  {
    id: 2,
    img: `${BASE}ASSETS/IMAGES/games/prototypes/braaiSimulator.webp`,
    gameTitle: "Braai Simulator",
    role: "Main Designer and Developer",
    description: "Take charge of a South African Braai Restaurant. Manage customers' orders, anger and moods. Be careful not to burn any items and enjoy the three rounds (Use WitsPrototypes as the password)",

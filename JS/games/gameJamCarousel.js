const gameJams = [
  {
    id: 1,
    img: `${BASE}ASSETS/IMAGES/games/gameJams/fishRescue.webp`,
    gameTitle: "Fish Rescue",
    role: "Primary Developer and Designer",
    description: "You are in charge of a rescue centre on the banks of a river. Fish are ashore needing your help. You are tasked to save these fish and rehabilitate them. Feed them. Make them comfortable. Give them love. Then release them! (Use the password WitsPrototypes to unlock the game!)",
    link: "https://lahlama.itch.io/fish-rescue"
  },
  {
    id: 2,
    img: `${BASE}ASSETS/IMAGES/games/gameJams/pacMan.webp`,
